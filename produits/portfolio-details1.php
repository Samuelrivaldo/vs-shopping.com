        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3> Informations  </h3>
              <ul>
                <li><strong>Nom</strong> : BUGATTI CENTODIECI </li>
                <li><strong>Catégorie</strong> : BUGATTI </li>
                <li><strong>Prix</strong> : 16.000.000 € </li>
            ...
            <div class="portfolio-description">
              <h2> Description : </h2>
              <p>
                Son moteur affiche 1600 chevaux pour un;
                W16 de 8 litres avec une vitesse de 380 km/h.</p>
            </div>
          </div>
