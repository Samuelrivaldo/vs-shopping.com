        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../assets/img/v2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/ROL1.jpg " alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3> Informations  </h3>
              <ul>
                <li><strong>Nom</strong> : ROLS-ROYCE BOAT TAIL </li>
                <li><strong>Catégorie</strong> : ROLS-ROYCE </li>
                <li><strong>Prix</strong> : 23.000.000 € </li>
            ...
            <div class="portfolio-description">
              ...
              <p>
                ...
                C'est la voiture la plus chère au monde; Sa puissance : 6,75 litres pour 563 chevaux
                Et renferme un V12 biturbo.</p>
