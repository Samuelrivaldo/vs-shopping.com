        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3> Informations  </h3>
              <ul>
                <li><strong>Nom</strong> :  ROLS-ROYCE SWEPTAIL </li>
                <li><strong>Catégorie</strong> : ROLS-ROYCE </li>
                <li><strong>Prix</strong> : 11,6.000.000 € </li>
          ...
          Ce modèle est spécialement conçu à la demande d'un client anonyme.
          Dispose des côtés luxes et nautiques</p>
