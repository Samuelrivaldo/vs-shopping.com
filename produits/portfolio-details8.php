        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../assets/img/MER1.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3> Informations  </h3>
              <ul>
                <li><strong>Nom</strong> :  MERCEDES-MAYBACH EXELERO  </li>
                <li><strong>Catégorie</strong> : MERCEDES </li>
                <li><strong>Prix</strong> : 7.000.000 € </li>
            ...
            <div class="portfolio-description">
              ...
              <p>
                ...
                Un seul exemplaire a été produit suite à
                une commande éffectuée par Fulda;
                Son moteur tourne à 5,9 litres et 700 chevaux.</p>
